...
export default function SettingsPage() {
  ...
  const addScheduleItem = () => {
    ...
    const schedule = [...(settings?.schedule || []), newScheduleItem];
    set("schedule", schedule);
    setNewScheduleItem({ day: "", time: "", note: "" });
  };

  const removeScheduleItem = (i: number) => {
    const schedule = settings.schedule.filter(
            ...
            <div className="bg-[#111] border border-white/5 rounded-2xl p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => set("streamer_avatar_url", e.target.value)}
            ...
            <div className="bg-[#111] border border-white/5 rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <input
                  ...
                  placeholder="Пн / Вторник / Каждый день"
