    ...
    <div className="space-y-10">
      ...
      <div>
        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">
          Привязанные <span className="text-[#9caffc]">аккаунты</span>
        </h1>
              ...
              <div className="mb-4">
                {telegramToken ? (
                  <div className="space-y-3">
                    ...
                    <div className="bg-[#0E0E0E] rounded-xl px-4 py-3 font-mono text-sm text-[#9caffc]">
                      /link {telegramToken}
                    </div>
                    <a
          ...
          {user?.has_twitch ? (
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full bg-[#1C1B1B] border border-white/10 text-white text-sm px-3 py-2 rounded-xl focus:outline-none focus:border-[#9caffc]/40"
              />
              <button
                onClick={saveTwitch}
                disabled={saving === "twitch"}
                className="w-full bg-[#9caffc] text-[#0a0a0a] py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-[#7b94f8] transition-colors disabled:opacity-50"
              >
        ...
        <div className="bg-[#111] rounded-2xl p-8 flex flex-col justify-between hover:bg-[#1C1B1B] transition-colors">
          ...
          {user?.has_steam ? (
            ...
            <button
              ...
              className="w-full bg-[#9caffc] text-[#0a0a0a] py-3 rounded-xl font-bold uppercase text-xs tracking-widest hover:bg-[#7b94f8] transition-all active:scale-95"
            >
              Привязать Steam
            </button>
          )}
      ...
      <div className="bg-[#111] border border-white/5 rounded-2xl p-8">
        ...
        <div className="flex gap-4 max-w-3xl">
          <input
            ...
            className="flex-1 bg-[#1C1B1B] border-0 border-b-2 border-white/10 focus:border-[#9caffc] text-white py-4 px-0 text-sm outline-none transition-colors"
          />
          <button
            onClick={saveSteam}
            disabled={saving === "steam"}
            className="bg-[#9caffc] text-[#0a0a0a] px-8 rounded-xl font-bold uppercase text-xs tracking-widest hover:bg-[#7b94f8] transition-all active:scale-95 disabled:opacity-50"
          >
        ...
        <p className="mt-4 text-sm text-white/40">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-[#9caffc] hover:underline ml-1"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-2xl">
              {[
                ...
                <input
                  ...
                  className="bg-[#1C1B1B] border border-white/5 text-white text-sm px-4 py-3 rounded-xl focus:outline-none focus:border-[#9caffc]/40"
                />
              ))}
            </div>
            <button
