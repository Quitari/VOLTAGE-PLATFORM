    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-[#0E0E0E] border-b-2 border-white/10 focus:border-[#9caffc] text-white px-4 py-3 pr-12 focus:outline-none transition-colors"
        />
        <button
          type="button"
    ...
    <div className="max-w-5xl pb-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <section className="bg-[#111] border border-white/5 rounded-2xl p-8 relative overflow-hidden">
            <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
              ...
              <div className="relative group cursor-pointer flex-shrink-0">
                <div className="w-28 h-28 rounded-full overflow-hidden border-2 border-[#9caffc] p-1 bg-[#0E0E0E] shadow-xl shadow-[#9caffc]/10">
                  <div className="w-full h-full rounded-full bg-[#1C1B1B] flex items-center justify-center text-[#9caffc] font-black text-3xl">
                    {user?.username?.slice(0, 2).toUpperCase()}
                  </div>
                </div>
                <div className="absolute inset-0 bg-black/60 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="material-symbols-outlined text-[#9caffc]">
                    photo_camera
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-5">
              <div>
                <label className="text-[10px] font-bold uppercase tracking-widest text-[#9caffc] block mb-1.5">
                  Отображаемое имя
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-[#0E0E0E] border-b-2 border-white/10 focus:border-[#9caffc] text-white px-4 py-3 focus:outline-none transition-colors"
                />
              </div>
              <div>
                <label className="text-[10px] font-bold uppercase tracking-widest text-[#9caffc] block mb-1.5">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 bg-[#0E0E0E] border-b-2 border-white/10 focus:border-[#9caffc] text-white px-4 py-3 focus:outline-none transition-colors"
                  />
              ...
              {/* Язык */}
              <div>
                <label className="text-[10px] font-bold uppercase tracking-widest text-[#9caffc] block mb-2">
                  Язык интерфейса
                </label>
                <div className="flex bg-[#0E0E0E] border border-white/5 p-1 rounded-xl w-fit">
                  <button className="px-6 py-1.5 rounded-lg bg-[#9caffc] text-[#0a0a0a] text-xs font-bold transition-all">
                    RU
                  </button>
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <section className="bg-[#111] border border-white/5 rounded-2xl p-8 border-t-4 border-t-[#9caffc]/20">
            <h2 className="text-xl font-black uppercase tracking-tight text-white mb-6 flex items-center gap-3">
              <span className="material-symbols-outlined text-[#9caffc]">
                lock
              </span>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-[#0A0A0A]/90 backdrop-blur-md z-40 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-8">
          <button
            onClick={handleSave}
            disabled={saving}
            className="w-full bg-[#9caffc] hover:bg-[#7b94f8] text-[#0a0a0a] font-black py-4 rounded-xl uppercase tracking-widest text-sm transition-all shadow-xl shadow-[#9caffc]/10 active:scale-[0.98] disabled:opacity-50"
          >
